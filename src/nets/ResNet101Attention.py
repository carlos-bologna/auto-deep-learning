...
class ResNet101Attention(nn.Module):

    def __init__(self, num_classes, attention=True, pretrained=True, normalize_attn=True):
        super(ResNet101Attention, self).__init__()
        self.attention = attention
        self.num_classes = num_classes
        self.pretrained = pretrained

        resnet101_model = resnet101(pretrained=pretrained)

        layers = [l for l in resnet101_model.children()]
